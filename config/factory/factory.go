...
import (
	...
	repository "meliarqsoft2/internal/infrastructure/repository/mongo/purchase"
	repository2 "meliarqsoft2/internal/infrastructure/repository/mongo/seller"
	repository3 "meliarqsoft2/internal/infrastructure/repository/mongo/user"
...
func (factory *Factory) BuildProductHandler() (*application.ProductService, *handler.ProductGinHandler) {
	repo := product.NewProductMongoRepository(factory.dbClient)
...
func (factory *Factory) BuildUserHandler() (*application3.UserService, *handler3.UserGinHandler) {
	repo := repository3.NewUserMongoRepository(factory.dbClient)
...
func (factory *Factory) BuildPurchaseHandler() (*application4.PurchaseService, *handler4.PurchaseGinHandler) {
	repo := repository.NewPurchaseMongoRepository(factory.dbClient)
